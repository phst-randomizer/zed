...
def main():
    ...
    instrumentsBySwav = [
        ...
        [(94, 0)],
        [(94, 0)],
        [(43, 6), (44, 6), (131, 12), (132, 12), (133, 12), (134, 12)],
        [(103, 6)],
        [(24, 3)],
        [(121, 1)],
        [(31, 2), (86, 5)],
        ...
        [(31, 2), (91, 3)],
        [(24, 6), (69, 6)],
        [(8, 1), (24, 6), (62, 1), (63, 1), (131, 35), (132, 35), (133, 35), (134, 35)],
        [(2, 2), (10, 2), (30, 3), (121, 5), (131, 17), (132, 17), (133, 17), (134, 17)],
        [(2, 2), (10, 2), (30, 3), (121, 5)],
        [(2, 2), (10, 2), (30, 3), (121, 5)],
        [(30, 3)],
        [(30, 3)],
        ...
        [(110, 0)],
        [(110, 0)],
        [(19, 4), (23, 3), (60, 2), (61, 2), (121, 4)],
        [(19, 4), (23, 3)],
        [(19, 4), (66, 3), (68, 3), (69, 3), (70, 3), (71, 3)],
        [(77, 5)],
        [(84, 2), (103, 4)],
        [(16, 7), (28, 0), (29, 0), (53, 17), (84, 2)],
        [(16, 7), (28, 0), (29, 0), (32, 6), (53, 17), (122, 0)],
        [(53, 17)],
        [(41, 3)],
        [(41, 3)],
        [(14, 4), (48, 1), (50, 0), (87, 0), (100, 0)],
        [(50, 0), (69, 8), (87, 0), (100, 0)],
        [(50, 0), (69, 8), (87, 0), (100, 0)],
        [(50, 0), (69, 8), (87, 0), (100, 0)],
        [(103, 4)],
        [(51, 0)],
        [(26, 3)],
        [(121, 2)],
        [(12, 7), (50, 4), (53, 14), (69, 2), (70, 10), (87, 4)],
        [
            (29, 5),
            (51, 3),
            (51, 9),
        ...
        [(27, 0)],
        [(117, 5)],
        [(80, 0), (131, 22), (132, 22), (133, 22), (134, 22)],
        [(78, 3)],
        [(78, 3)],
        [(80, 2)],
        [(118, 0)],
        [(80, 1), (131, 23), (132, 23), (133, 23), (134, 23)],
        [(34, 0), (35, 3), (45, 0)],
        [(115, 2)],
        [(117, 0)],
        [(1, 1), (15, 1), (35, 2), (45, 3), (118, 10), (128, 1)],
        [(1, 1), (15, 1), (45, 3), (118, 10), (128, 1)],
        [(13, 3), (35, 4), (37, 0), (40, 2)],
        [(37, 0)],
        [(15, 3), (27, 1), (45, 5)],
        [(15, 3), (45, 5)],
        [(15, 3), (45, 5)],
        [(78, 2), (117, 1)],
        [(34, 2), (35, 1), (37, 5), (104, 8), (107, 10), (120, 5)],
        [
            (45, 2),
            (79, 2),
            (80, 3),
        ...
        [(40, 1)],
        [(37, 2), (118, 2)],
        [(16, 6), (17, 6), (36, 2), (38, 10), (40, 4), (79, 3)],
        [(1, 5), (39, 0), (40, 3), (47, 6), (48, 6), (78, 6), (128, 5)],
        [(1, 5), (13, 5), (37, 6), (39, 0), (47, 6), (48, 6), (78, 6), (120, 6), (128, 5)],
        [(1, 6), (13, 6)],
        [(1, 6)],
        [(1, 3)],
        [(1, 3), (118, 3)],
        ...
        [(3, 7), (88, 4)],
        [(46, 1), (47, 8), (48, 8), (83, 2), (84, 3), (90, 4), (93, 1), (99, 2), (102, 4)],
        [(49, 5), (70, 7), (109, 11)],
        [(42, 0), (58, 2), (59, 2)],
        [(42, 0), (58, 2), (59, 2), (82, 5)],
        [(7, 8), (28, 6), (49, 3), (83, 3), (99, 5), (109, 5), (113, 0)],
        [(5, 8)],
        [(5, 8), (7, 8), (46, 0), (109, 5), (113, 0)],
        [(5, 8), (7, 8), (46, 0), (113, 0)],
        [(84, 3), (91, 4), (102, 1), (102, 3), (108, 11)],
        [(26, 6), (83, 3)],
        [(26, 6)],
        [(11, 2)],
        [(89, 0), (102, 1), (102, 3), (126, 2)],
        [(89, 0)],
        [(26, 1)],
        [(31, 2), (91, 3)],
        [(76, 3), (112, 3)],
        ...
        [(17, 10), (29, 2), (30, 2), (53, 20), (64, 1), (65, 1), (109, 12)],
        [(20, 6), (39, 1), (70, 1), (76, 6), (77, 2), (112, 6)],
        [(39, 1), (70, 1), (76, 6), (77, 2), (112, 6)],
        [(105, 4)],
        [
            (38, 5),
            (131, 2),
        ...
        [(46, 0)],
        [(99, 5)],
        [(4, 1), (5, 1), (7, 1), (19, 0), (48, 9), (60, 1), (61, 1), (82, 0)],
        [(4, 1), (5, 1), (7, 1), (19, 0), (60, 1), (61, 1), (82, 0)],
        [(18, 3), (131, 1), (132, 1), (133, 1), (134, 1)],
        [(13, 7), (16, 2), (28, 4), (32, 8), (71, 4)],
        [(13, 7), (16, 2), (28, 4), (32, 8), (71, 4)],
        [(13, 7), (71, 4)],
        [(16, 2), (28, 4), (32, 8)],
        [(13, 7), (71, 4)],
        [(16, 2), (28, 4), (32, 8), (56, 1), (57, 1)],
        [(24, 5)],
        [(25, 4), (116, 8)],
        [(103, 3), (131, 3), (132, 3), (133, 3), (134, 3)],
        [(43, 2), (44, 2), (77, 7), (84, 3), (91, 4), (102, 5)],
        [(43, 2), (44, 2)],
        [(51, 1), (103, 9)],
        [(77, 7)],
        [(31, 6), (121, 6)],
        ...
        [(9, 4)],
        [(8, 4)],
        [(28, 5), (38, 4), (46, 2), (53, 15), (82, 8), (107, 12), (108, 12), (122, 4)],
        [(28, 5), (38, 4), (46, 2), (53, 15), (82, 8)],
        [(3, 1), (109, 1)],
        [
            (3, 1),
            (5, 13),
        ...
        [(3, 1), (5, 13), (66, 1), (67, 1), (73, 7), (82, 11), (85, 2), (109, 1)],
        [(52, 5)],
        [(41, 0)],
        [(41, 0)],
        [(8, 3), (9, 3)],
        [(8, 2), (9, 2)],
        [(17, 12), (30, 4), (30, 5)],
        [(10, 0), (17, 12), (30, 4), (30, 5)],
        [(10, 0), (17, 12), (30, 4), (30, 5)],
        [(17, 12), (30, 4), (30, 5)],
        [(10, 0), (17, 12), (30, 4), (30, 5)],
        [(10, 0), (17, 12), (30, 4), (30, 5)],
        [(97, 3), (101, 3), (104, 6)],
        [(49, 0), (82, 10), (97, 3), (101, 3), (106, 0)],
        [(49, 0), (97, 3), (101, 3)],
        [(49, 0), (82, 10), (97, 3), (101, 3), (106, 0)],
        [(49, 0), (82, 10), (97, 3), (101, 3), (104, 6)],
        [(49, 0), (97, 3), (101, 3), (106, 0)],
        [(18, 2), (21, 3)],
        [(4, 12), (5, 9), (5, 10), (5, 12)],
        [(4, 12), (5, 9), (5, 10), (5, 12)],
        [(33, 1), (85, 4)],
        ...
        [(52, 3)],
        [(52, 3), (104, 1)],
        [(96, 6), (105, 2), (106, 2), (107, 2), (108, 2), (114, 1)],
        [(104, 1), (105, 2), (106, 2), (107, 2), (108, 2), (111, 8), (114, 1)],
        [(104, 1), (105, 2), (106, 2), (107, 2), (108, 2)],
        [(96, 8), (104, 1)],
        [(96, 8)],
        [(23, 2)],
        [(23, 2)],
        ...
        [(30, 0)],
        [(19, 8), (109, 8)],
        [(22, 4), (68, 8), (76, 0), (109, 8), (112, 0)],
        [(68, 8), (76, 0), (109, 8), (112, 0)],
        [(22, 4)],
        [(19, 8)],
        [(6, 14), (68, 8), (109, 8)],
        [(74, 1), (75, 1), (92, 1)],
        ...
        [(52, 2)],
        [(52, 2), (88, 0)],
        [(2, 3), (3, 0), (5, 11), (131, 13), (132, 13), (133, 13), (134, 13)],
        [(2, 3), (3, 0), (5, 11), (126, 3)],
        [(5, 11)],
        [(47, 0), (48, 0), (99, 0)],
        [(47, 0), (48, 0), (99, 0)],
        ...
        [(41, 1), (91, 2)],
        [(41, 1), (86, 2), (91, 2)],
        [(103, 8), (131, 14), (132, 14), (133, 14), (134, 14)],
        [(86, 8), (104, 9), (107, 3), (108, 3)],
        [(86, 8), (104, 9), (107, 3), (108, 3)],
        [(88, 3)],
        [(20, 3), (22, 3), (86, 3)],
        [(22, 3), (86, 3)],
        ...
        [(109, 7), (128, 3)],
        [(16, 3), (32, 7), (82, 1), (109, 7), (122, 9), (128, 3)],
        [
            (4, 3),
            (5, 3),
            (6, 3),
        ...
        [(4, 7), (5, 7), (7, 7), (82, 3), (109, 14)],
        [(4, 7), (5, 7), (7, 7), (82, 3), (109, 14)],
        [(42, 2), (46, 9), (47, 5), (48, 5), (56, 4), (57, 4), (93, 0), (98, 1)],
        [
            (5, 9),
            (6, 9),
            (7, 9),
        ...
        [(12, 1), (28, 1), (32, 9), (53, 13), (109, 3)],
        [(5, 9), (6, 9), (39, 5), (46, 8), (47, 3), (71, 7), (82, 12), (98, 0), (99, 1), (109, 3)],
        [
            (5, 9),
            (7, 9),
            (12, 1),
        ...
        [(25, 3), (86, 10)],
        [(91, 2)],
        [(12, 3), (42, 2), (46, 9), (47, 5), (48, 5), (93, 0), (98, 1), (113, 4)],
        [(12, 3), (42, 2), (46, 9), (47, 5), (48, 5), (56, 4), (57, 4), (93, 0), (98, 1), (113, 4)],
        [(42, 2), (46, 9), (98, 1)],
        [(93, 0)],
        [(12, 4)],
        [(12, 4)],
        ...
        [(22, 0)],
        [(124, 3), (125, 3)],
        [(14, 0), (28, 2), (50, 3), (62, 2), (63, 2), (87, 3), (87, 7), (122, 2)],
        [(96, 5)],
        [(114, 3)],
        [(114, 3)],
        [(14, 6), (50, 6), (51, 11), (130, 1)],
        [(14, 6), (50, 6)],
        [(22, 20)],
        [(75, 0), (92, 0)],
        [(51, 5)],
        ...
        [(50, 5), (100, 5)],
        [(91, 1), (111, 5)],
        [(88, 1), (89, 4), (90, 6), (102, 6), (104, 0)],
        [(51, 12), (52, 1)],
        [(51, 12), (51, 13), (52, 1), (103, 5)],
        [(31, 1), (51, 6), (103, 0)],
        [(31, 1)],
        [(31, 4), (116, 9)],
        [(24, 1)],
        ...
        [(52, 4)],
        [(88, 1), (90, 2), (102, 2)],
        [(52, 4), (88, 2), (89, 2), (90, 2), (102, 2), (107, 9)],
        [(52, 4)],
        [(90, 2), (102, 2)],
        [(90, 2), (102, 2)],
        [(88, 2), (89, 2), (107, 9), (126, 0)],
        [(11, 3), (64, 2), (65, 2), (126, 4)],
        [(24, 2)],
        [(24, 2)],
        [(24, 2)],
        [(24, 2)],
        ...
        [(12, 5), (19, 3), (20, 4), (85, 1)],
        [(12, 5), (19, 3), (20, 4), (85, 1)],
        [(12, 5), (19, 3), (20, 4), (85, 1), (113, 2)],
        [(21, 4), (22, 2)],
        [(21, 4), (22, 2)],
        [(21, 4)],
        [(21, 4), (22, 2)],
        [(19, 2), (23, 6), (24, 4), (43, 7), (44, 7), (69, 4)],
        [(19, 2), (23, 6), (24, 4), (43, 7), (53, 9), (69, 4), (73, 9)],
        [(19, 2), (24, 4), (43, 7), (44, 7), (69, 4), (73, 9)],
        [(19, 2), (23, 6), (24, 4), (43, 7), (44, 7), (69, 4), (73, 9)],
        [(26, 7)],
        [(26, 7)],
        [(26, 7)],
        [(26, 7)],
        [(42, 5), (72, 1), (77, 6), (84, 0), (99, 4), (131, 6), (132, 6), (133, 6), (134, 6)],
        [
            (42, 5),
            (64, 5),
            (65, 5),
        ...
        [(5, 4), (53, 2), (53, 6), (73, 2), (73, 6), (131, 0), (132, 0), (133, 0), (134, 0)],
        [(114, 0), (131, 0), (132, 0), (133, 0), (134, 0)],
        [(83, 1), (96, 2)],
        [(33, 3), (82, 7), (83, 1), (96, 2), (109, 15)],
        [(83, 1)],
        [(33, 3), (82, 7), (83, 1), (109, 15)],
        [(33, 3), (82, 7), (83, 1), (109, 15)],
        [(97, 0), (104, 4)],
        [(97, 0), (104, 4)],
        [(51, 10), (105, 8), (106, 8), (110, 2)],
        [(18, 1), (36, 0), (104, 11), (105, 8), (106, 8)],
        [(18, 1), (36, 0), (110, 2)],
        [(110, 2)],
        [(36, 0), (110, 2)],
        [(77, 4)],
        ...
        [(21, 1), (96, 1), (111, 1)],
        [(21, 1)],
        [(3, 3), (10, 3), (49, 1), (85, 3), (131, 8), (132, 8), (133, 8), (134, 8)],
        [(3, 3), (10, 3), (49, 1), (51, 13), (85, 3)],
        [(109, 2)],
        [(109, 2)],
        [(109, 2)],
        [(109, 2)],
    ...
    mergedInstruments = (
        []
    )  # [{swav, swav, swav}, ...]: the same as above, but overlapping instruments are combined
    for i in range(568):
